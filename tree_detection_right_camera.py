...
while True: 
    ...
    if (box_3==[] and box_2==[] and box_1==[] and box_0 != []) or (box_1==[] and box_0 != [] and abs(tree_pixel - prev_tree_pixel) > 210):
        ...
        # if (abs(x - center_pixel) < 110 and abs(center_tree - prev_center_tree) < 90) or (abs(x - center_pixel) > 110 and abs(center_tree - prev_center_tree) < 110):
        #     print(prev_center_tree)
        #     print(center_tree)
        #     print(x)
        #     print(center_pixel)
        #     print('stop')
